...
> **Note:** `components/app/` contains 8 files total. `empty-state.tsx` is a Server Component (pure presentation, no browser APIs) and is listed below.**
...
| **EmptyState** | `components/app/empty-state.tsx` | Server Component for empty list states |
...
pnpm test:e2e      # Playwright — 48 E2E tests pass (10 specs, requires Playwright browsers)
...
pnpm test:e2e          # Playwright — 48 E2E tests, 10 specs, Chromium
