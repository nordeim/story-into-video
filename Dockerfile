...
#
# Security:
#   - Non-root user (storyintovideo, uid 1001)
...
RUN addgroup -g 1001 -S storyintovideo && \
    adduser -S storyintovideo -G storyintovideo -u 1001 && \
    chown -R storyintovideo:storyintovideo /app
